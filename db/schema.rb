...
ActiveRecord::Schema[7.0].define(version: 2022_08_12_151257) do
  ...
  create_table "medicos", force: :cascade do |t|
    ...
    t.index ["consulta_id"], name: "index_medicos_on_consulta_id"
  end
  ...
  add_foreign_key "medicos", "consulta", column: "consulta_id"
end
