...
class MedicosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medico" do
    assert_difference("Medico.count") do
      post medicos_url, params: { medico: { cpf: @medico.cpf, email: @medico.email, especialidade: @medico.especialidade, numero_do_crm: @medico.numero_do_crm, primeiro_nome: @medico.primeiro_nome, ultimo_nome: @medico.ultimo_nome } }
    end
  ...
  test "should update medico" do
    patch medico_url(@medico), params: { medico: { cpf: @medico.cpf, email: @medico.email, especialidade: @medico.especialidade, numero_do_crm: @medico.numero_do_crm, primeiro_nome: @medico.primeiro_nome, ultimo_nome: @medico.ultimo_nome } }
