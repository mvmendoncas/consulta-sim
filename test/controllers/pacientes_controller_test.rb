...
class PacientesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paciente" do
    assert_difference("Paciente.count") do
      post pacientes_url, params: { paciente: { cpf: @paciente.cpf, data_de_nascimento: @paciente.data_de_nascimento, email: @paciente.email, primeiro_nome: @paciente.primeiro_nome, ultimo_nome: @paciente.ultimo_nome } }
    end
  ...
  test "should update paciente" do
    patch paciente_url(@paciente), params: { paciente: { cpf: @paciente.cpf, data_de_nascimento: @paciente.data_de_nascimento, email: @paciente.email, primeiro_nome: @paciente.primeiro_nome, ultimo_nome: @paciente.ultimo_nome } }
